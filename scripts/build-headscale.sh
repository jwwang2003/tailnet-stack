...
release_version=${HEADSCALE_VERSION:-v0.29.3-feishu.1}
...
go mod download
go mod verify
go build -trimpath -buildmode=pie -ldflags "-X main.version=$release_version" -o "$output_directory/headscale" ./cmd/headscale
