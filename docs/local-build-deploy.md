...
python3 scripts/image-bundle.py export \
  ...
  --output /mnt/c/Users/wjw/Downloads/fysics-bundle-2026.09-rc.3-01
```
...
```text
C:\Users\wjw\Downloads\fysics-bundle-2026.09-rc.3-01\
  images.tar
  manifest.json
```
...
```powershell
scp -r "C:\Users\wjw\Downloads\fysics-bundle-2026.09-rc.3-01" "wjw@8.133.246.13:~/"
```
...
```text
/home/wjw/fysics-bundle-2026.09-rc.3-01/images.tar
/home/wjw/fysics-bundle-2026.09-rc.3-01/manifest.json
```
...
git fetch origin release/integrated-2026.09-rc.3
```
...
p = Path.home() / 'fysics-bundle-2026.09-rc.3-01/manifest.json'
...
python3 scripts/image-bundle.py import \
  --bundle "$HOME/fysics-bundle-2026.09-rc.3-01" \
  --runtime .runtime
```
